...
public class Stud extends Connectivity implements ICustom2DField, Cloneable {
	int height;
	int width;
	...
	public void setMatrixItem(String studMatrixString) {
		matrixItem = new MatrixItem[height + 1][width + 1];
		String[] values = studMatrixString.split(",");
		int count = 0;
