...
Source: "..\..\Data\*"; DestDir: "{app}\Data"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: data                Source: "..\..\Resource\*"; DestDir: "{app}\Resource"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: data
Source: "C:\ldraw\p\*"; DestDir: "{app}\ldraw\p"; Flags: onlyifdoesntexist recursesubdirs createallsubdirs; Components: ldraw
Source: "C:\ldraw\parts\*"; DestDir: "{app}\ldraw\parts"; Flags: onlyifdoesntexist recursesubdirs createallsubdirs; Components: ldraw
Source: "C:\ldraw\ldconfig.ldr"; DestDir: "{app}\ldraw\"; Flags: onlyifdoesntexist recursesubdirs createallsubdirs; Components: ldraw
