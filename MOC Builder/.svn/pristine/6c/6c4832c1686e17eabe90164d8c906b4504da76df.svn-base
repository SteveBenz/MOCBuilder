...
public class CocoaUIEnhancer {
	...
	static long actionProc(long id, long sel, long arg0) throws Exception {
        ...
        if ( sel == sel_aboutMenuItemSelected_ ) {
        	...
        	view.showDialog(Display.getDefault());
        }
     ...
     */
    public void hookApplicationMenu( final Display display, Listener quitListener,MessageBox box, PreferencesView view ) {
    ...
    private void initialize()
		...
		proc3Args = new Callback(CocoaUIEnhancer.class, "actionProc", 3); //$NON-NLS-1$
