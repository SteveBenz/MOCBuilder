...
AllowNoIcons=yes
OutputDir=D:\Dev\viewer\BrickBuilder
OutputBaseFilename=BrickBuilder
SetupIconFile=D:\Dev\viewer\BrickBuilder\BrickBuilder.ico
Compression=lzma
...
Name: "data"; Description: "BrickBuilder Data"; Types: full compact; Flags: fixed
Name: "ldraw"; Description: "LDraw Data"; Types: full

[Files]
Source: "D:\Dev\viewer\BrickBuilder\WIN64\brickbuilder.exe"; DestDir: "{app}"; Components: program; Flags: ignoreversion; Check: IsX64
Source: "D:\Dev\viewer\BrickBuilder\WIN32\brickbuilder.exe"; DestDir: "{app}"; Components: program; Flags: ignoreversion; Check: not IsX64
Source: "D:\Dev\viewer\BrickBuilder\data\Data\*"; DestDir: "{app}\Data"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: data                
Source: "D:\Dev\viewer\BrickBuilder\data\Resource\*"; DestDir: "{app}\Resource"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: data
Source: "D:\Dev\viewer\BrickBuilder\data\ldraw\*"; DestDir: "{app}\ldraw"; Flags: onlyifdoesntexist recursesubdirs createallsubdirs; Components: ldraw
