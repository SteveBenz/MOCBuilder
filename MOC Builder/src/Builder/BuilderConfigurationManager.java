...
public class BuilderConfigurationManager {
	...
	private String configurationFilename = "Resource/MOCBuilder.ini";
	...
	private BuilderConfigurationManager() {
		System.out.println(System.getProperty("user.dir")+"/LDraw/");
		DefaultLDrawDirectory = System.getProperty("user.dir")+"LDraw/";
