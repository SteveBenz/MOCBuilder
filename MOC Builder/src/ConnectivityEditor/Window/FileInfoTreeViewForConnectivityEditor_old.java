...
public class FileInfoTreeViewForConnectivityEditor_old implements Runnable {
	private Tree fileInfoTreeComponent = null;
	private ConnectivityEditor connectivityEditor = null;
	private boolean isTerminate = false;

	public FileInfoTreeViewForConnectivityEditor_old(ConnectivityEditor builder) {
	...
	public void generateView(final Composite parent) {
		...
		fileInfoTreeComponent
				.addKeyListener(new ConnectivityEditorEventHandler(
