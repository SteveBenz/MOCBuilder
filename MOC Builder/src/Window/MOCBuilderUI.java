...
//		 mocBuilder.openFile(System.getProperty("user.home")+"/untitled.ldr");
	...
	private void initEventListener() {
		...
		EventHandlerForCursor cursorEventHandler = new EventHandlerForCursor(
				mainView);
		glcanvas.addMouseListener(cursorEventHandler);
		glcanvas.addMouseMoveListener(cursorEventHandler);
		glcanvas.addMouseWheelListener(cursorEventHandler);
		glcanvas.addMouseTrackListener(cursorEventHandler);
