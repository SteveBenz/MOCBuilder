...
public class ShortcutDlg extends Dialog {
	...
	private void createTable() {
		...
		int index = 0;
		for (Entry<ShortcutKeyT, String> entry : ShortcutKeyManager.getInstance()
				.getKeyMap().entrySet()) {
							...
							if (column == 3) {
								...
								text.addFocusListener(new FocusListener() {
									...
									public void focusLost(FocusEvent arg0) {
										newKeyMap.put(ShortcutKeyT.byValue(item.getText(1)),
												text.getText());
								...
								text.addKeyListener(new KeyListener() {
									...
									private boolean isConflict(String desc,
										...
										for (Entry<ShortcutKeyT, String> entry : keyMap
												.entrySet()) {
											if (desc.equals(entry.getKey().getDescription()))
												continue;
